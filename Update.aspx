<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Mobile.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="taskrabbit2.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    ErrorMessage="Mobile number is required" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
     ...
     <div class="row">
        <asp:Button ID="update" runat="server" Text="Update" style="background-color: black; color: #fff; border: 1px solid #007bff;" OnClick="Update_Click"/>
    </div>
   </div>
</div>
